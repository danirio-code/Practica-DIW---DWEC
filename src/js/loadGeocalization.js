...
if (
  window.location.pathname === '/dist/location.html' ||
  window.location.pathname === '/location.html'
) {
  initMap();
}
...
const rutaTramuntana = [
  ...
  { lat: 39.56706, lng: 2.618386 },
  { lat: 39.569211, lng: 2.621261 },
  { lat: 39.56931, lng: 2.62154 },
...
const rutaCampastilla = [
  ...
  { lat: 39.53497, lng: 2.720583 },
  { lat: 39.534186, lng: 2.721761 },
  { lat: 39.53056, lng: 2.728437 },
